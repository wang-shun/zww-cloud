...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    {
        return new ApiRequestMatchingFilter(new AntPathRequestMatcher[]{new AntPathRequestMatcher("/api/register"),new AntPathRequestMatcher("/api/guest")} , new AntPathRequestMatcher("/api/**"), new AntPathRequestMatcher("/zww/**"));
    }
