...
public interface MemberChargeHistoryMapper extends BaseMapper<MemberChargeHistory> {
    ...
    //分页
    List<Map<String, Object>> selectList(@Param("page") Page<MemberChargeHistory> page, @Param("memberId")Integer memberId,@Param("name")String name,@Param("machineCode")String machineCode,@Param("chargeDate")String chargeDate);
