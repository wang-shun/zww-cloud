...
public interface TAgentMapper extends BaseMapper<TAgent> {
    ...
    List<Map<String, Object>> selectByLevel(@Param("page") Page<TAgent> page, @Param("nickName") String condition, @Param("phone") String phone, @Param("createTime") String createTime, @Param("level") Integer level, @Param("id")Integer id);
