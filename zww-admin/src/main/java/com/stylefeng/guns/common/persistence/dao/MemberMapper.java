...
public interface MemberMapper extends BaseMapper<Member> {
     ...
     */
    List<Map<String, Object>> selectMember(@Param("page") Page<Member> page,@Param("id") Integer id,@Param("userName") String userName,@Param("phone") String phone,@Param("beginTime") String beginTime,@Param("phoneModel") String phoneModel);
