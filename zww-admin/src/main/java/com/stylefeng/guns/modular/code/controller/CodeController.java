...
import com.stylefeng.guns.config.properties.GunsZwwProperties;
...
public class CodeController extends BaseController {
    ...
    @Autowired
    private GunsZwwProperties zwwProperties;
    /**
     * 跳转到代码生成主页
     */
    @RequestMapping("")
    ...
    public Object generate(GenQo genQo) {
    	...
    	if ("zww".equals(genQo.getDbName())) {
    		genQo.setUrl(zwwProperties.getUrl());
            genQo.setUserName(zwwProperties.getUsername());
            genQo.setPassword(zwwProperties.getPassword());
    	} else {
