 ...
 */
var ChargeOrder = {
    id: "xiaoyaojingChargeOrderChannelTable",	//表格id
    seItem: null,		//选中的条目
    table: null,
    layerIndex: -1
};
...
ChargeOrder.initColumn = function () {
    return [
        {field: 'selectItem', radio: true},
            ...
            {title: '设备', field: 'lastLoginFrom', visible: true, align: 'center', valign: 'middle'},
            ...
            {title: '用户id', field: 'memberNum', visible: true, align: 'center', valign: 'middle'},
...
ChargeOrder.loadMoney = function(){
    var ajax = new $ax(Feng.ctxPath + "/chargeOrder/xiaoyaojignAllMoneyChannel", function (data) {
        $("#allMoney").val(data);
        // ChargeOrder.table.refresh();
    }, function (data) {
...
ChargeOrder.loadPerson = function(){
    var ajax = new $ax(Feng.ctxPath + "/chargeOrder/xiaoyaojignAllPersonChannel", function (data) {
        $("#allPerson").val(data);
        // ChargeOrder.table.refresh();
    }, function (data) {
        Feng.error("失败!" + data.responseJSON.message + "!");
...
$(function () {
    ...
    var table = new BSTable(ChargeOrder.id, "/chargeOrder/xiaoyaojingChannelList", defaultColunms);
