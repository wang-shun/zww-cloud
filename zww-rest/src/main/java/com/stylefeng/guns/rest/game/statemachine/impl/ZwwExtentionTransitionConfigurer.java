...
public class ZwwExtentionTransitionConfigurer<T, S> implements ExternalTransitionConfigurer<T, S>{
	...
	public ZwwExtentionTransitionConfigurer(StateMachineTransitionConfigurer<T, S> configure){
