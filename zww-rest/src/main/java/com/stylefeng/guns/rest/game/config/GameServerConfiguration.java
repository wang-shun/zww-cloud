package com.stylefeng.guns.rest.game.config;
...
import com.stylefeng.guns.rest.game.BMDataContext;
import com.stylefeng.guns.rest.util.UKTools;
  
@org.springframework.context.annotation.Configuration  
@ConfigurationProperties(prefix = GameServerConfiguration.GAME_SERVER_CONFIG)
public class GameServerConfiguration  
{  	
	 public static final String GAME_SERVER_CONFIG = "uk.im.server";
...
//		config.setOrigin("http://im.uckefu.com");
		config.setExceptionListener(new ZwwExceptionListener());
